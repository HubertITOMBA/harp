...
export default async function ServerListPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 via-gray-200 to-orange-50 p-2 sm:p-3 lg:p-4">
      <div className="max-w-[110rem] mx-auto space-y-2 w-full">
