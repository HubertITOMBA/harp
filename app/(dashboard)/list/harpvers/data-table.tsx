  ...
  return (
    <>
     ...
     <div className="flex items-center py-4 ">
        <Input
          placeholder="Filtrer par Version ..."
          value={(table.getColumn("harprelease")?.getFilterValue() as string) ?? ""}
          onChange={(event) =>
            table.getColumn("harprelease")?.setFilterValue(event.target.value)
          }
