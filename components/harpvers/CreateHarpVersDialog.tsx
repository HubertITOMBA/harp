...
import { createHarpVers } from '@/actions/create-harpvers';
import { toast } from 'react-toastify';

export function CreateHarpVersDialog() {
  ...
  const handleSubmit = async (
    ...
    startTransition(async () => {
      const result = await createHarpVers(formData);
      ...
      if (result.success) {
        ...
        toast.error(result.error || "Erreur lors de la création de la release");
        if (result.error) {
  ...
  return (
    <FormDialog
      ...
      description="Remplissez les informations pour créer une nouvelle release"
