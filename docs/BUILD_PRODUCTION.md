...
$env:AUTH_URL="http://portails.orange-harp.fr:9352"
$env:NEXT_PUBLIC_SERVER_URL="http://portails.orange-harp.fr:9352"
...
```bash
# Définir les variables pour cette session
export AUTH_URL="http://portails.orange-harp.fr:9352"
export NEXT_PUBLIC_SERVER_URL="http://portails.orange-harp.fr:9352"
...
Après le build, vérifiez dans `.next/server/app-paths-manifest.json` ou dans les fichiers générés que les URLs utilisent bien `http://portails.orange-harp.fr:9352` et non `localhost:9352`.
...
2. **Vérifier les requêtes réseau** :
   ...
   - Vérifier que les requêtes RSC utilisent `http://portails.orange-harp.fr:9352` et non `:9352`
