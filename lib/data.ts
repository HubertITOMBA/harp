...
export const calendarEvents = [
  {
    title: "Math",
    allDay: false,
    start: new Date(2024, 12, 2, 8, 0),
    end: new Date(2024, 12, 2, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2024, 12, 2, 9, 0),
    end: new Date(2024, 12, 2, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2024, 12, 2, 10, 0),
    end: new Date(2024, 12, 2, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2024, 12, 2, 11, 0),
    end: new Date(2024, 12, 2, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2024, 12, 2, 13, 0),
    end: new Date(2024, 12, 2, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2024, 12, 2, 14, 0),
    end: new Date(2024, 12, 2, 14, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2024, 12, 3, 9, 0),
    end: new Date(2024, 12, 3, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2024, 12, 3, 10, 0),
    end: new Date(2024, 12, 3, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2024, 12, 3, 11, 0),
    end: new Date(2024, 12, 3, 11, 45),
  },

  {
    title: "History",
    allDay: false,
    start: new Date(2024, 12, 3, 14, 0),
    end: new Date(2024, 12, 3, 14, 45),
  },
  {
    title: "Math",
    allDay: false,
